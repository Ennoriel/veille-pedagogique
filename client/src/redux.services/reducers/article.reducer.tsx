...
const fakeArticleState = {
    1: {
        ...
        language: 'fr',
        medium: 'video',
        createdAt: new Date(1503180000000),
    ...
    2: {
        ...
        createdAt: new Date(1532901600000),
    ...
    3: {
        ...
        language: 'fr',
        medium: 'article blog',
        createdAt: new Date(1533765600000),
    ...
    4: {
        ...
        language: 'en',
        medium: 'article blog',
        createdAt: new Date(1512169200000),
    ...
    5: {
        title: "titre",
        url: "http://toto.fr/article/3",
        language: "fr",
        medium: "article presse",
        description: "description",
        siteInternet: "toto.fr",
        themes: ["pedagogie"],
        auteur: [2, 3],
        tweetId: [17],
        createdAt: new Date(1547397111000)
    }
}
